...
desc 'Generate documentation for the export_products extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ExportProductsExtension'
...
desc 'Test the export_products extension.'
...
namespace :test do
  desc 'Functional test the export_products extension.'
  ...
  desc 'Unit test the export_products extension.'
